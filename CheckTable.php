...
<table class="table table-bordered table-striped table-hover text-center">
    ...
    <tr>
        ...
        <td>لیست چک ها</td>
        <td> <?php $calender->GetDayCheck('1',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('2',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('3',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('4',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('5',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('6',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('7',$month,$year , 1) ?> </td>
    ...
    <tr>
        ...
        <td> <?php $calender->GetDayCheckSum('1',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('2',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('3',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('4',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('5',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('6',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('7',$month,$year , 1) ?> </td>
...
<table class="table table-bordered table-striped table-hover text-center">
    ...
    <tr>
        ...
        <td>لیست چک ها</td>
        <td> <?php $calender->GetDayCheck('8',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('9',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('10',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('11',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('12',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('13',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('14',$month,$year , 1) ?> </td>
    </tr>
    ...
    <tr>
        ...
        <td> <?php $calender->GetDayCheckSum('8',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('9',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('10',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('11',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('12',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('13',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('14',$month,$year , 1) ?> </td>
    </tr>
...
<table class="table table-bordered table-striped table-hover text-center">
    ...
    <tr>
        ...
        <td>لیست چک ها</td>
        <td> <?php $calender->GetDayCheck('15',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('16',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('17',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('18',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('19',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('20',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('21',$month,$year , 1) ?> </td>
    </tr>
    ...
    <tr>
        ...
        <td> <?php $calender->GetDayCheckSum('15',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('16',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('17',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('18',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('19',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('20',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('21',$month,$year , 1) ?> </td>
...
<table class="table table-bordered table-striped table-hover text-center">
    ...
    <tr>
        ...
        <td>لیست چک ها</td>
        <td> <?php $calender->GetDayCheck('22',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('23',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('24',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('25',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('26',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('27',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('28',$month,$year , 1) ?> </td>
    </tr>

    <tr>

        <td style="color red">جمع تحویل نشده</td>
        <td> <?php $calender->GetDayCheckSum('22',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('23',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('24',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('25',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('26',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('27',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('28',$month,$year , 1) ?> </td>
    </tr>
...
<table class="table table-bordered table-striped table-hover text-center">
    ...
    <tr>
        ...
        <td> <?php $calender->GetDayCheck('29',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('30',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheck('31',$month,$year , 1) ?> </td>
    ...
    <tr>
        ...
        <td> <?php $calender->GetDayCheckSum('29',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('30',$month,$year , 1) ?> </td>
        <td> <?php $calender->GetDayCheckSum('31',$month,$year , 1) ?> </td>
...
<input type="submit" value="تجمیع" class="form-control input-lg btn btn-lg btn-success">
</form>
