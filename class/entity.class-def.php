        ...
        if($result->rowCount() > '0') {
            ...
            <table width="100%" id=""
                ...
                <tr style="">
                    ...
                    <td style="color:black; font-size: 17px; background-color: #02B875"><span id="stdResult"></span>نام کالا</td>
                    ...
                    <td  style="color:black; font-size: 17px; background-color: #72b1ff">فروشگاه ها</td>
                    <td  style="color:black; font-size: 17px; background-color: #72b1ff">جمع کل فروشگاه ها</td>
                    <td>قیمت فروش</td>
                ...
                foreach ($data as $rows) {
                    ...
                    <tr title="کد کالا :     <?php echo $rows->productid; ?>    &nbsp;&nbsp;&nbsp;  نام کالا : <?php echo $this->productname; ?> "           >
                        ...
                        <td style="color:black; font-size: 17px; background-color: #afd9ee" <?php if ($rows->feshantion == '1') {
                            echo '  style="background-color: pink"';
                        } ?> contenteditable="true" onblur="saveToDatabase(this,'hajmi','<?php echo $rows->id; ?>')" ondblclick="showEdit(this);"><?php echo $rows->discounthajmi; ?>  </td>
                        ...
                        <td  <?php if ($rows->feshantion == '1') {
                            echo '  style="background-color: pink"';
                        } ?> contenteditable="true" onblur="saveToDatabase(this,'tax','<?php echo $rows->id; ?>')" ondblclick="showEdit(this);" ><?php echo $rows->tax; ?> </td>
                        ...
                        <td  style="color:black; font-size: 17px; background-color: #72b1ff">
                            12<?php $df3 = round($df2 + (($df2/100) * 5)); echo  number_format($df3); ?></td>
                        <td  style="color:black; font-size: 17px; background-color: #72b1ff"><?php if($rows->feshantion != 1)
                            {
                        ...
                        <td <?php if ($rows->feshantion == '1') {
                            ...
                            if($_SESSION['UserLevel'] == '1' || $_SESSION['UserLevel'] == '2' || $_SESSION['UserLevel'] == '3'  )
                            {
                                ...
                                <?php
                                if($_SESSION['UserId'] == "1" || $_SESSION['UserId'] == "9" || $_SESSION['UserId'] == "13" || $_SESSION['UserId'] == "55")
                                {
                                    ?>
                                    <br><br><br>
                ...
                <td></td>
                <td style="color:black; font-size: 17px; background-color: #afd9ee"></td>
                <td></td>
                <td  style="color:black; font-size: 17px; background-color: #f8ff6f"></td>
                ...
                <td> </td>
                <td style="color:black; font-size: 17px; background-color: #72b1ff"><?php echo number_format(round($store_sum)); ?> </td>/td>
